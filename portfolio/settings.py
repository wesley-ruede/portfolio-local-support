...
SECRET_KEY = 'c=1z-uz3ocpe=*#9%n01x@uin2rp_repbx+b$s_t@++$b+h%35'
...
INSTALLED_APPS = [
    'blog.apps.BlogConfig', #installed blogs app
    'jobs.apps.JobsConfig', #installed jobs app
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'portfolio/static/') #static directories
]
